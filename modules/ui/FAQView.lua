...
local PAGES = {
{
    ...
    lines = {
        ...
        "  divided back out -- the two reasons this was unsupported",
        "  since 2.33 (best-of-3-based decision, threshold moves with",
        "  charges)",
        "- Now shown in the Tuning Advisor window, included in",
        "  Continuous Auto-Tune, and in Export (AI)",
        "- Live pacing behavior unchanged -- only fixes what the",
        "  suggestion itself is calculated from",
        "",
