...
},
{
    ...
    lines = {
        ...
        "",
        GOLD .. "Tuning proposals" .. R,
        "Optional and off by default. Proposals never mutate a live build",
        "automatically; review the evidence and use Apply deliberately.",
    },
},
{
    title = "Character: visual talents and gear",
    lines = {
        GOLD .. "Overview" .. R,
        "Summarizes current talents, the saved-snapshot comparison,",
        "equipped/resolved item counts, and glyph coverage.",
        "",
        GOLD .. "Talents" .. R,
        "One familiar tree at a time with icons, ranks, and tree tabs.",
        "Current / Saved / Difference expose missing (!) and extra (+)",
        "ranks. List view provides the same comparison as readable text.",
        "",
        GOLD .. "Gear" .. R,
        "All 19 slots appear in a paper-doll layout. Click a slot for",
        "item level, modeled score, and recognized weighted stats.",
        GREY .. "Pending data is never scored as zero; this is directional" .. R,
        GREY .. "guidance, not a best-in-slot verdict." .. R,
        "",
        "Adopt current snapshot edits the draft; Save commits, Cancel discards.",
    },
},
{
...
},
{
    ...
    lines = {
        ...
        "build's settings.",
        "",
        GOLD .. "Review-first proposals (4.0)" .. R,
        "Prepare tuning proposals is off by default. It stages small",
        "evidence-based changes and shows a toast, but never changes",
        "the live build automatically. Review, then use Apply.",
        "",
