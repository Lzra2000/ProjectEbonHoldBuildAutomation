...
StaticPopupDialogs["EBONBUILDS_WIZARD_NO_ECHOES"] = {
    text = "You haven't rated any specific echoes yet -- automation will rely purely on quality and family bonuses, with no differentiation between individual echoes. Continue anyway?",
    button1 = "Continue",
    button2 = "Go back",
    OnAccept = function()
...
local function WizardWeightFn(name)
