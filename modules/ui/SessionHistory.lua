...
local FormatDuration, FormatTimestamp, FormatRunDate = Data.FormatDuration, Data.FormatTimestamp, Data.FormatRunDate
local NormalizeAction, DecisionSource, TargetChoice = Data.NormalizeAction, Data.DecisionSource, Data.TargetChoice
local IsImportant, ReasonSentence, DecisionLabel = Data.IsImportant, Data.ReasonSentence, Data.DecisionLabel
local GetRunCompletionState, RunDisplayEndTime, RunStatusLabel = Data.GetRunCompletionState, Data.RunDisplayEndTime, Data.RunStatusLabel
local RunQualitySummary, RunDisplayLevel, QualityCountText, SessionSummary = Data.RunQualitySummary, Data.RunDisplayLevel, Data.QualityCountText, Data.SessionSummary
local RunIsShort, RunIsRecent, RunBrowserSearchBlob, RunRelativeDate = Data.RunIsShort, Data.RunIsRecent, Data.RunBrowserSearchBlob, Data.RunRelativeDate
local ResourceDisplayText, NextWheelScrollValue = Data.ResourceDisplayText, Data.NextWheelScrollValue
local SearchSafeLower, VisibleEchoName = Data.SearchSafeLower, Data.VisibleEchoName
local ResourceChangeSummary = Data.ResourceChangeSummary
...
local function EntryMatches(entry)
    return Data.EntryMatches(entry, FilterState())
end

local function VisibleItems(logs)
    return Data.VisibleItems(logs, FilterState())
end
...
local function SessionMatchesActiveBuild(session)
    ...
    local build = EbonBuilds.Build and EbonBuilds.Build.GetActive and EbonBuilds.Build.GetActive()
    return Data.SessionMatchesBuild(session, build)
end
