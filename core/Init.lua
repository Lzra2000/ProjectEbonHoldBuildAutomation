...
local function RegisterModules()
    ...
    M.RegisterLegacy("auctionatorBridge", M.CORE, "AuctionatorBridge", "Init", { "database" })
    M.RegisterLegacy("peAffixBridge", M.CORE, "ProjectEbonholdAffixBridge", "Init", { "database" })
    M.RegisterLegacy("sharedLoadoutBridge", M.CORE, "SharedLoadoutBridge", "Init", { "database", "projectAPI" })
