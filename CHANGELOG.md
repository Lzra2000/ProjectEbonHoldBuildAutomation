...
#### Fixed
- **Details_ProjectEbonhold 1.0.9-pe1:** PE Proc Sources Breakdown layout denser ? right panels use native field order + source-share/sibling blocks (less empty void), Targets lists the focused proc too, Breakdown docks beside the meter and flips left if it would clip. Custom Display script v9.
